...
public class RichButton extends AppCompatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.RichButton);
        drawableWidth = a.getDimensionPixelSize(R.styleable.RichButton_rbtn_drawable_width, 0);
        drawableHeight = a.getDimensionPixelSize(R.styleable.RichButton_rbtn_drawable_height, 0);
        a.recycle();
        Drawable[] drawables;
