...
/**
 * Created by ts_xiaoA on 2019/11/17 on 1:21
 * E-Mail Address：443502578@qq.com
 * Desc:
 */
public class ItemMenuLayout extends ViewGroup {

    private final String TAG = String.valueOf(this.getClass());
    ...
    //存储的是当前正在展开的View
    private static ItemMenuLayout mViewCache;
     ...
     * @param ios
     */
    public ItemMenuLayout setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public ItemMenuLayout setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static ItemMenuLayout getViewCache() {
        return mViewCache;
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childView.getVisibility() != GONE) {
                ...
                if (i > 0) {//第一个布局是Left item，从第二个开始才是RightMenu
                    ...
                    int height = MeasureSpec.makeMeasureSpec(contentHeight, MeasureSpec.EXACTLY);
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = ItemMenuLayout.this;
...
//        mExpandAnim.setInterpolator(new OvershootInterpolator());
        ...
        mExpandAnim.setDuration(100).start();
    }
